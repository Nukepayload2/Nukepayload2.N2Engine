Namespace Foundation
    ...
    ''' </summary>
    Public Class RelayPropertyBinder(Of T)
        ...
        ''' 绑定到另一个绑定器
        ''' </summary>
        Sub New(another As RelayPropertyBinder(Of T))
            Bind(another)
        End Sub
        ...
        ''' 检查是否可以读取值
        ''' </summary>
        Public ReadOnly Property CanRead As Boolean Implements PropertyBinder(Of T).CanRead
            Get
        ...
        ''' 检查是否可以写入值
        ''' </summary>
        Public ReadOnly Property CanWrite As Boolean Implements PropertyBinder(Of T).CanWrite
            Get
        ...
        Public Shared Narrowing Operator CType(binder As RelayPropertyBinder(Of T)) As T
            Return binder.Value
        End Operator

        Public Shared Widening Operator CType(val As T) As RelayPropertyBinder(Of T)
            Return New RelayPropertyBinder(Of T)(val)
        End Operator

        ''' <summary>
        ''' 绑定到另一个绑定器
        ''' </summary>
        Public Sub Bind(another As RelayPropertyBinder(Of T))
