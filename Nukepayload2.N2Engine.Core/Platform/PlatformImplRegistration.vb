...
Namespace Platform
    ...
    Public Class PlatformImplRegistration
        ...
        ''' 正在注册的平台
        ''' </summary>
        Dim curPlatform As Platforms
        ''' <summary>
        ''' 创建一个平台的注册
        ''' </summary>
        ''' <param name="platform">注意：平台不能为 <see cref="Platforms.Unknown"/> </param>
        Sub New(platform As Platforms)
            If platform = Global.Nukepayload2.N2Engine.Platform.Platforms.Unknown Then
